...
import az.edu.ada.wm2.resfuldemo.model.mapper.ProductMapperManual;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductDto save(ProductDto pDto) {
        ...
        return ProductMapperManual.productToProductDto(
                prodRepo.save(ProductMapperManual.productDtoToProduct(pDto))
        );
    }
